 ...
 */
@ToString
public class ByHandleFileInfo extends Struct {
     ...
     */
    @NonNull
    public WindowsFileTime ftCreationTime;
     ...
     */
    @NonNull
    public WindowsFileTime ftLastAccessTime;
     ...
     */
    @NonNull
    public WindowsFileTime ftLastWriteTime;
    ...
    public ByHandleFileInfo(final WindowsFileTime creationTime, final WindowsFileTime lastAccessTime, final WindowsFileTime lastWriteTime) {
...
*/
    ...
    void setTimes(final WindowsFileTime creationTime, final WindowsFileTime lastAccessTime, final WindowsFileTime lastWriteTime) {
        val now = DokanyUtils.getCurrentTime();
